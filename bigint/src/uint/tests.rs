...
pub fn u256_div() {
    ...
    assert_eq!(
        U256::from_str("0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFD")
            .unwrap() / U256::from_str("2").unwrap(),
        U256::from_str("0x7FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFE")
            .unwrap()
    );
}
...
pub fn uint256_mul_overflow_panic() {
    let _res = U256::from_str("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")
        .unwrap()
        * U256::from_str("7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff")
            .unwrap();
}
...
pub fn uint256_sub_overflow_panic() {
    let _res = U256::from_str("0").unwrap() - U256::from_str("1").unwrap();
}
...
fn u512_multi_adds() {
    ...
    let (_, overflow) = U512([0, 0, 0, 0, 0, 0, 0, ::std::u64::MAX]).overflowing_add(U512([
        0,
        0,
        0,
        0,
...
fn u256_multi_adds() {
    ...
    let (_, overflow) =
        U256([0, 0, 0, ::std::u64::MAX]).overflowing_add(U256([0, 0, 0, ::std::u64::MAX]));
    assert!(overflow);
}
...
fn u256_multi_subs() {
    ...
    let (result, overflow) = U256([
        ::std::u64::MAX,
        ::std::u64::MAX,
        ::std::u64::MAX,
        ::std::u64::MAX,
    ]).overflowing_sub(U256([
        ::std::u64::MAX / 2,
        ::std::u64::MAX / 2,
        ::std::u64::MAX / 2,
        ::std::u64::MAX / 2,
    ...
    assert!(!overflow);
    assert_eq!(
        U256([::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX, 0]),
        result
    );
}
...
fn u256_multi_carry_all() {
    let (result, _) =
        U256([::std::u64::MAX, 0, 0, 0]).overflowing_mul(U256([::std::u64::MAX, 0, 0, 0]));
    assert_eq!(U256([1, ::std::u64::MAX - 1, 0, 0]), result);

    let (result, _) =
        U256([0, ::std::u64::MAX, 0, 0]).overflowing_mul(U256([::std::u64::MAX, 0, 0, 0]));
    assert_eq!(U256([0, 1, ::std::u64::MAX - 1, 0]), result);

    let (result, _) = U256([::std::u64::MAX, ::std::u64::MAX, 0, 0]).overflowing_mul(U256([
        ::std::u64::MAX,
        0,
        0,
        0,
    ...
    let (result, _) = U256([::std::u64::MAX, 0, 0, 0]).overflowing_mul(U256([
        ::std::u64::MAX,
        ::std::u64::MAX,
        0,
        0,
    ...
    assert_eq!(
        U256([1, ::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX - 1]),
        result
    );
    ...
    assert_eq!(
        U256([1, ::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX]),
        result
    );
    ...
    let (result, _) =
        U256([::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX, 0]).overflowing_mul(U256([
            ::std::u64::MAX,
            ::std::u64::MAX,
            ::std::u64::MAX,
            ::std::u64::MAX,
    ...
    let (result, _) =
        U256([0, 0, 0, ::std::u64::MAX]).overflowing_mul(U256([0, 0, 0, ::std::u64::MAX]));
...
fn u256_multi_muls_overflow() {
    ...
    let (_, overflow) =
        U256([0, 1, 0, ::std::u64::MAX]).overflowing_mul(U256([0, 1, 0, ::std::u64::MAX]));
    assert!(overflow);

    let (_, overflow) =
        U256([0, ::std::u64::MAX, 0, 0]).overflowing_mul(U256([0, ::std::u64::MAX, 0, 0]));
    assert!(!overflow);
...
fn u256_multi_full_mul() {
    ...
    let result =
        U256([::std::u64::MAX, ::std::u64::MAX, 0, 0]).full_mul(U256([::std::u64::MAX, 0, 0, 0]));
    assert_eq!(
        U512([1, ::std::u64::MAX, ::std::u64::MAX - 1, 0, 0, 0, 0, 0]),
        result
    );

    let result =
        U256([::std::u64::MAX, 0, 0, 0]).full_mul(U256([::std::u64::MAX, ::std::u64::MAX, 0, 0]));
    assert_eq!(
        U512([1, ::std::u64::MAX, ::std::u64::MAX - 1, 0, 0, 0, 0, 0]),
        result
    );

    let result = U256([::std::u64::MAX, ::std::u64::MAX, 0, 0]).full_mul(U256([
        ::std::u64::MAX,
        ::std::u64::MAX,
        0,
        0,
    ...
    assert_eq!(
        U512([1, 0, ::std::u64::MAX - 1, ::std::u64::MAX, 0, 0, 0, 0]),
        result
    );

    let result = U256([::std::u64::MAX, 0, 0, 0]).full_mul(U256([
        ::std::u64::MAX,
        ::std::u64::MAX,
        ::std::u64::MAX,
        0,
    ...
    let result = U256([::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX, 0]).full_mul(U256([
        ::std::u64::MAX,
        0,
        0,
        0,
    ...
    let result = U256([
        ...
        ::std::u64::MAX,
        ::std::u64::MAX,
    ]).full_mul(U256([::std::u64::MAX, 0, 0, 0]));
    assert_eq!(
        U512([
            1,
            ::std::u64::MAX,
    ...
    let result = U256([
        ...
        ::std::u64::MAX,
        ::std::u64::MAX,
    ]).full_mul(U256([::std::u64::MAX, ::std::u64::MAX, 0, 0]));
    assert_eq!(
        U512([
            1,
            0,
    ...
    let result = U256([
        ...
        ::std::u64::MAX,
        ::std::u64::MAX,
    ]).full_mul(U256([::std::u64::MAX, ::std::u64::MAX, ::std::u64::MAX, 0]));
    assert_eq!(
        U512([
            1,
            0,
